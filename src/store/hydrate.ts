...
import { simulateIdleRun, simulateGatheringClear, calcClearTime } from '../engine/zones';
...
import { getClassClearSpeedModifier, getClassDamageModifier } from '../engine/classResource';
