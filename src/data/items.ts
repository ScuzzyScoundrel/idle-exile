...
export const ITEM_BASE_DEFS: ItemBaseDef[] = [
  ...
  { id: 'worn_tome',         name: 'Worn Tome',         slot: 'mainhand', weaponType: 'tome', baseStats: { spellPower: 16, abilityHaste: 3, baseAttackSpeed: 7, baseCritChance: 2 }, baseSpellPower: 16, iLvl: 1 },
  { id: 'arcane_tome',       name: 'Arcane Tome',       slot: 'mainhand', weaponType: 'tome', baseStats: { spellPower: 30, abilityHaste: 6, baseAttackSpeed: 9, baseCritChance: 3 }, baseSpellPower: 30, iLvl: 10 },
  { id: 'obsidian_tome',     name: 'Obsidian Tome',     slot: 'mainhand', weaponType: 'tome', baseStats: { spellPower: 48, abilityHaste: 10, baseAttackSpeed: 11, baseCritChance: 4 }, baseSpellPower: 48, iLvl: 20 },
  { id: 'mithril_tome',      name: 'Mithril Tome',      slot: 'mainhand', weaponType: 'tome', baseStats: { spellPower: 66, abilityHaste: 14, baseAttackSpeed: 14, baseCritChance: 5 }, baseSpellPower: 66, iLvl: 30 },
  { id: 'void_tome',         name: 'Void Tome',         slot: 'mainhand', weaponType: 'tome', baseStats: { spellPower: 96, abilityHaste: 20, baseAttackSpeed: 17, baseCritChance: 7 }, baseSpellPower: 96, iLvl: 45 },
  { id: 'starforged_tome',   name: 'Starforged Tome',   slot: 'mainhand', weaponType: 'tome', baseStats: { spellPower: 132, abilityHaste: 26, baseAttackSpeed: 21, baseCritChance: 9 }, baseSpellPower: 132, iLvl: 60 },
