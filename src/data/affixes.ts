...
export const AFFIX_DEFS: AffixDef[] = [
  ...
  },
  {
    ...
    tiers: buildTiers(1, 4, 3, 6, 5, 9, 8, 16, 14, 22, 19, 28),
  ...
  {
    id: 'all_resist', name: 'of the Elements', category: 'all_resist',
    slot: 'suffix', stat: 'allResist',
    allowedSlots: ['rings', 'amulets'],
    tiers: buildTiers(1, 2, 2, 3, 3, 5, 4, 8, 7, 12, 10, 16),
    weight: 50, displayTemplate: '+{value}% All Resistances',
  },
