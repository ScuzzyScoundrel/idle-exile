...
export const STAFF_ACTIVE_SKILLS: ActiveSkillDef[] = [
  ...
  // ── 3. Haunt ──
  {
    id: 'staff_haunt',
    name: 'Haunt',
    description: 'Send a spirit to haunt the target, dealing chaos damage over time. On target death: spirit chains to next enemy with fresh duration. Creates Haunted (5s).',
    weaponType: 'staff',
    tags: ['Spell', 'Chaos', 'DoT', 'Chain'],
    baseDamage: 8.136,
    weaponDamagePercent: 0,
    spellPowerRatio: 1.356,
    castTime: 1.0,
    cooldown: 5,
    levelRequired: 1,
    icon: '👻',
  ...
  // ── 5. Spirit Barrage ──
  {
    ...
    name: 'Spirit Barrage',
    description: 'Unleash 3 rapid chaos-spirit blasts. Consumes Haunted for guaranteed crits and +30% bonus damage on all hits.',
    weaponType: 'staff',
  ...
  // ── 9. Bouncing Skull ──
  {
    ...
    name: 'Bouncing Skull',
    description: 'Hurl a chaos-bound skull that bounces between enemies, applying poison on each hit. Consumes Soul Stacks for +1 bounce per stack consumed (max 5 stacks = up to 7 bounces).',
    weaponType: 'staff',
    tags: ['Spell', 'Chaos', 'Chain', 'Projectile'],
    baseDamage: 27.12,
    weaponDamagePercent: 0,
    spellPowerRatio: 3.797,
    castTime: 1.0,
    cooldown: 5,
    levelRequired: 1,
    icon: '🔥',
