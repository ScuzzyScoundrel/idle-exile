...
export const COMBO_STATE_SPECS: Record<string, ComboStateSpec> = {
  ...
  soul_stack: {
    id: 'soul_stack',
    name: 'Soul Stack',
    description: 'The Witch Doctor\'s ledger. Soul Harvest reaps +2 (max 6). Bouncing Skull consumes ALL stacks: +30% damage and +1 bounce per stack, PERFECT at 6 (×2.5 + advances other cooldowns 1s). Mass Sacrifice devours them for its own ritual.',
    defaultDuration: 10,
    maxStacks: 6,
    defaultEffect: { extraChains: 1, incDamagePerStackConsumed: 30, capBonus: { incDamage: 150, advanceOthersSec: 1 } },
    category: 'stack',
    side: 'player',
  },
  ritual_frenzy: {
