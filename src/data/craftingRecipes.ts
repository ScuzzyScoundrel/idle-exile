...
// ─── Tier Constants ───────────────────────────────────────────────
// Gold:  T1=0, T2=0, T3=0, T4=15, T5=40, T6=100
...
const ARMOR_TIER_CONFIG = [
  { tier: 1, reqLevel: 1, iLvl: 5, gold: 0, matAmt: 3 },
  { tier: 2, reqLevel: 15, iLvl: 15, gold: 0, matAmt: 4 },
  { tier: 3, reqLevel: 30, iLvl: 25, gold: 0, matAmt: 5 },
  { tier: 4, reqLevel: 50, iLvl: 35, gold: 15, matAmt: 6 },
  { tier: 5, reqLevel: 75, iLvl: 45, gold: 40, matAmt: 8 },
  { tier: 6, reqLevel: 90, iLvl: 55, gold: 100, matAmt: 10 },
] as const;
...
const weaponsmithRecipes: CraftingRecipeDef[] = [
  ...
  // --- Dagger T1-T6 ---
  {
    ...
    goldCost: 0, outputBaseId: 'crude_dagger', outputILvl: 5, catalystSlot: true,
  },
  {
    ...
    goldCost: 0, outputBaseId: 'steel_stiletto', outputILvl: 15, catalystSlot: true,
  },
  {
    ...
    goldCost: 0, outputBaseId: 'obsidian_kris', outputILvl: 25, catalystSlot: true,
  },
  {
    ...
    goldCost: 15, outputBaseId: 'mithril_dirk', outputILvl: 35, catalystSlot: true,
  },
  {
    ...
    goldCost: 40, outputBaseId: 'runic_shiv', outputILvl: 45, catalystSlot: true,
  },
  {
    ...
    goldCost: 100, outputBaseId: 'void_fang', outputILvl: 55, catalystSlot: true,
  },
  ...
  // --- Wand T1-T6 ---
  {
    ...
    materials: [{ materialId: 'cindite_ingot', amount: 3 }, { materialId: 'emberwood_plank', amount: 3 }],
    goldCost: 0, outputBaseId: 'twig_wand', outputILvl: 5, catalystSlot: true,
  },
  {
    id: 'ws_t2_wand', profession: 'weaponsmith', name: 'Ferrite Wand', tier: 2, requiredLevel: 15,
    materials: [{ materialId: 'ferrite_ingot', amount: 4 }, { materialId: 'ironwood_plank', amount: 4 }],
    goldCost: 0, outputBaseId: 'bone_wand', outputILvl: 15, catalystSlot: true,
  },
  {
    id: 'ws_t3_wand', profession: 'weaponsmith', name: 'Alloy Wand', tier: 3, requiredLevel: 30,
    materials: [{ materialId: 'forged_alloy', amount: 5 }, { materialId: 'steelwood_plank', amount: 5 }],
    goldCost: 0, outputBaseId: 'obsidian_wand', outputILvl: 25, catalystSlot: true,
  },
  {
    id: 'ws_t4_wand', profession: 'weaponsmith', name: 'Voidsteel Wand', tier: 4, requiredLevel: 50,
    materials: [{ materialId: 'voidsteel_ingot', amount: 6 }, { materialId: 'shadowwood_plank', amount: 6 }],
    goldCost: 15, outputBaseId: 'mithril_wand', outputILvl: 35, catalystSlot: true,
  },
  {
    id: 'ws_t5_wand', profession: 'weaponsmith', name: 'Celesteel Wand', tier: 5, requiredLevel: 75,
    materials: [{ materialId: 'celesteel_ingot', amount: 8 }, { materialId: 'dreadwood_plank', amount: 8 }],
    goldCost: 40, outputBaseId: 'runic_wand', outputILvl: 45, catalystSlot: true,
  },
  {
    id: 'ws_t6_wand', profession: 'weaponsmith', name: 'Primordial Wand', tier: 6, requiredLevel: 90,
    materials: [{ materialId: 'primordial_ingot', amount: 10 }, { materialId: 'primordial_plank', amount: 10 }],
    goldCost: 100, outputBaseId: 'void_wand', outputILvl: 55, catalystSlot: true,
  },
  ...
  // --- Bow T1-T6 ---
  {
    ...
    materials: [{ materialId: 'cindite_ingot', amount: 3 }, { materialId: 'emberwood_plank', amount: 3 }],
    goldCost: 0, outputBaseId: 'shortbow', outputILvl: 5, catalystSlot: true,
  },
  {
    id: 'ws_t2_bow', profession: 'weaponsmith', name: 'Ferrite Recurve', tier: 2, requiredLevel: 15,
    materials: [{ materialId: 'ferrite_ingot', amount: 4 }, { materialId: 'ironwood_plank', amount: 4 }],
    goldCost: 0, outputBaseId: 'recurve_bow', outputILvl: 15, catalystSlot: true,
  },
  {
    id: 'ws_t3_bow', profession: 'weaponsmith', name: 'Alloy Longbow', tier: 3, requiredLevel: 30,
    materials: [{ materialId: 'forged_alloy', amount: 5 }, { materialId: 'steelwood_plank', amount: 5 }],
    goldCost: 0, outputBaseId: 'obsidian_longbow', outputILvl: 25, catalystSlot: true,
  },
  {
    id: 'ws_t4_bow', profession: 'weaponsmith', name: 'Voidsteel Bow', tier: 4, requiredLevel: 50,
    materials: [{ materialId: 'voidsteel_ingot', amount: 6 }, { materialId: 'shadowwood_plank', amount: 6 }],
    goldCost: 15, outputBaseId: 'mithril_bow', outputILvl: 35, catalystSlot: true,
  },
  {
    id: 'ws_t5_bow', profession: 'weaponsmith', name: 'Celesteel Bow', tier: 5, requiredLevel: 75,
    materials: [{ materialId: 'celesteel_ingot', amount: 8 }, { materialId: 'dreadwood_plank', amount: 8 }],
    goldCost: 40, outputBaseId: 'runic_bow', outputILvl: 45, catalystSlot: true,
  },
  {
    id: 'ws_t6_bow', profession: 'weaponsmith', name: 'Primordial Bow', tier: 6, requiredLevel: 90,
    materials: [{ materialId: 'primordial_ingot', amount: 10 }, { materialId: 'primordial_plank', amount: 10 }],
    goldCost: 100, outputBaseId: 'void_bow', outputILvl: 55, catalystSlot: true,
  },
  ...
  // --- Staff T1-T4 + T6 (T5 runic_staff already exists above) ---
  {
    ...
    materials: [{ materialId: 'cindite_ingot', amount: 3 }, { materialId: 'emberwood_plank', amount: 3 }],
    goldCost: 0, outputBaseId: 'gnarled_staff', outputILvl: 5, catalystSlot: true,
  },
  {
    id: 'ws_t2_staff', profession: 'weaponsmith', name: 'Ferrite Staff', tier: 2, requiredLevel: 15,
    materials: [{ materialId: 'ferrite_ingot', amount: 4 }, { materialId: 'ironwood_plank', amount: 4 }],
    goldCost: 0, outputBaseId: 'ironshod_staff', outputILvl: 15, catalystSlot: true,
  },
  {
    id: 'ws_t3_staff', profession: 'weaponsmith', name: 'Alloy Staff', tier: 3, requiredLevel: 30,
    materials: [{ materialId: 'forged_alloy', amount: 5 }, { materialId: 'steelwood_plank', amount: 5 }],
    goldCost: 0, outputBaseId: 'obsidian_staff', outputILvl: 25, catalystSlot: true,
  },
  {
    id: 'ws_t4_staff', profession: 'weaponsmith', name: 'Voidsteel Staff', tier: 4, requiredLevel: 50,
    materials: [{ materialId: 'voidsteel_ingot', amount: 6 }, { materialId: 'shadowwood_plank', amount: 6 }],
    goldCost: 15, outputBaseId: 'mithril_staff', outputILvl: 35, catalystSlot: true,
  },
  {
    id: 'ws_t6_staff', profession: 'weaponsmith', name: 'Primordial Staff', tier: 6, requiredLevel: 90,
    materials: [{ materialId: 'primordial_ingot', amount: 10 }, { materialId: 'primordial_plank', amount: 10 }],
    goldCost: 100, outputBaseId: 'void_staff', outputILvl: 55, catalystSlot: true,
  },
...
const armorerRecipes: CraftingRecipeDef[] = [
  ...
  // Extra: bracers (not in 6-slot grid)
  {
    ...
    goldCost: 0, outputBaseId: 'wrapped_bracers', outputILvl: 5, catalystSlot: true,
  },
  {
    ...
    goldCost: 0, outputBaseId: 'fortified_bracers', outputILvl: 15, catalystSlot: true,
  },
];
...
const leatherworkerRecipes: CraftingRecipeDef[] = [
  ...
  // Extra: cloak
  {
    ...
    goldCost: 15, outputBaseId: 'mithril_cloak', outputILvl: 35, catalystSlot: true,
  },
];
...
const jewelerRecipes: CraftingRecipeDef[] = [
  ...
  // Tier 1
  {
    ...
    goldCost: 0, outputBaseId: 'copper_band', outputILvl: 5, catalystSlot: true,
  },
  {
    id: 'je_t1_belt', profession: 'jeweler', name: 'Cindite Buckle', tier: 1, requiredLevel: 1,
    materials: [{ materialId: 'cindite_ingot', amount: 3 }, { materialId: 'wispbloom_extract', amount: 3 }],
    goldCost: 0, outputBaseId: 'rope_belt', outputILvl: 5, catalystSlot: true,
  },
  // Tier 2
  {
    ...
    goldCost: 0, outputBaseId: 'silver_ring', outputILvl: 15, catalystSlot: true,
  },
  {
    id: 'je_t2_belt', profession: 'jeweler', name: 'Ferrite Girdle', tier: 2, requiredLevel: 15,
    materials: [{ materialId: 'ferrite_ingot', amount: 4 }, { materialId: 'potent_tincture', amount: 4 }],
    goldCost: 0, outputBaseId: 'studded_belt', outputILvl: 15, catalystSlot: true,
  },
  // Tier 3
  {
    ...
    goldCost: 0, outputBaseId: 'gold_signet', outputILvl: 25, catalystSlot: true,
  },
  {
    id: 'je_t3_belt', profession: 'jeweler', name: 'Alloy Girdle', tier: 3, requiredLevel: 30,
    materials: [{ materialId: 'forged_alloy', amount: 5 }, { materialId: 'lustral_essence', amount: 5 }],
    goldCost: 0, outputBaseId: 'runed_girdle', outputILvl: 25, catalystSlot: true,
  },
  // Tier 4
  {
    ...
    goldCost: 15, outputBaseId: 'ruby_ring', outputILvl: 35, catalystSlot: true,
  },
  {
    id: 'je_t4_belt', profession: 'jeweler', name: 'Void Girdle', tier: 4, requiredLevel: 50,
    materials: [{ materialId: 'voidsteel_ingot', amount: 6 }, { materialId: 'shadow_elixir', amount: 6 }],
    goldCost: 15, outputBaseId: 'mithril_belt', outputILvl: 35, catalystSlot: true,
  },
  // Tier 5
  {
    ...
    goldCost: 40, outputBaseId: 'astral_ring', outputILvl: 45, catalystSlot: true,
  },
  {
    id: 'je_t5_belt', profession: 'jeweler', name: 'Celesteel Belt', tier: 5, requiredLevel: 75,
    materials: [{ materialId: 'celesteel_ingot', amount: 8 }, { materialId: 'tempest_distillate', amount: 8 }],
    goldCost: 40, outputBaseId: 'runic_girdle', outputILvl: 45, catalystSlot: true,
  },
  // Tier 6
  {
    ...
    goldCost: 100, outputBaseId: 'starforged_signet', outputILvl: 55, catalystSlot: true,
  },
  {
    id: 'je_t6_belt', profession: 'jeweler', name: 'Primordial Belt', tier: 6, requiredLevel: 90,
    materials: [{ materialId: 'primordial_ingot', amount: 10 }, { materialId: 'primordial_essence', amount: 10 }],
    goldCost: 100, outputBaseId: 'void_belt', outputILvl: 55, catalystSlot: true,
  },
  ...
  // Tier 1
  {
    ...
    goldCost: 0, outputBaseId: 'bone_charm', outputILvl: 5, catalystSlot: true,
  },
  {
    id: 'je_t1_trinket', profession: 'jeweler', name: 'Minor Tincture', tier: 1, requiredLevel: 1,
    materials: [{ materialId: 'wispbloom_extract', amount: 3 }, { materialId: 'fish_oil', amount: 3 }],
    goldCost: 0, outputBaseId: 'cracked_gem', outputILvl: 5, catalystSlot: true,
  },
  // Tier 2
  {
    ...
    goldCost: 0, outputBaseId: 'jade_amulet', outputILvl: 15, catalystSlot: true,
  },
  {
    id: 'je_t2_crystal', profession: 'jeweler', name: 'Potent Crystal', tier: 2, requiredLevel: 15,
    materials: [{ materialId: 'potent_tincture', amount: 4 }, { materialId: 'aqua_reagent', amount: 4 }],
    goldCost: 0, outputBaseId: 'polished_stone', outputILvl: 15, catalystSlot: true,
  },
  // Tier 3
  {
    ...
    goldCost: 0, outputBaseId: 'onyx_pendant', outputILvl: 25, catalystSlot: true,
  },
  {
    id: 'je_t3_shard', profession: 'jeweler', name: 'Frost Shard', tier: 3, requiredLevel: 30,
    materials: [{ materialId: 'lustral_essence', amount: 5 }, { materialId: 'frost_reagent', amount: 5 }],
    goldCost: 0, outputBaseId: 'prismatic_shard', outputILvl: 25, catalystSlot: true,
  },
  // Tier 4
  {
    ...
    goldCost: 15, outputBaseId: 'ruby_amulet', outputILvl: 35, catalystSlot: true,
  },
  {
    id: 'je_t4_crystal', profession: 'jeweler', name: 'Abyssal Crystal', tier: 4, requiredLevel: 50,
    materials: [{ materialId: 'shadow_elixir', amount: 6 }, { materialId: 'abyssal_reagent', amount: 6 }],
    goldCost: 15, outputBaseId: 'infused_crystal', outputILvl: 35, catalystSlot: true,
  },
  // Tier 5
  {
    ...
    goldCost: 40, outputBaseId: 'void_pendant', outputILvl: 45, catalystSlot: true,
  },
  {
    id: 'je_t5_prism', profession: 'jeweler', name: 'Storm Prism', tier: 5, requiredLevel: 75,
    materials: [{ materialId: 'tempest_distillate', amount: 8 }, { materialId: 'tempest_reagent', amount: 8 }],
    goldCost: 40, outputBaseId: 'void_shard', outputILvl: 45, catalystSlot: true,
  },
  // Tier 6
  {
    ...
    goldCost: 100, outputBaseId: 'astral_choker', outputILvl: 55, catalystSlot: true,
  },
  {
    id: 'je_t6_prism', profession: 'jeweler', name: 'Primordial Prism', tier: 6, requiredLevel: 90,
    materials: [{ materialId: 'primordial_essence', amount: 10 }, { materialId: 'primordial_reagent', amount: 10 }],
    goldCost: 100, outputBaseId: 'astral_prism', outputILvl: 55, catalystSlot: true,
  },
];
...
const uniqueRecipes: CraftingRecipeDef[] = [
  {
    ...
    goldCost: 100, outputBaseId: 'astral_ring', outputILvl: 45,
  ...
  },
  {
    ...
    goldCost: 150, outputBaseId: 'runic_greatsword', outputILvl: 50,
  ...
  },
  {
    ...
    goldCost: 150, outputBaseId: 'astral_choker', outputILvl: 50,
  ...
  },
  {
    ...
    goldCost: 100, outputBaseId: 'runic_bulwark', outputILvl: 40,
  ...
  },
  {
    ...
    goldCost: 150, outputBaseId: 'void_robe', outputILvl: 50,
  ...
  },
  {
    ...
    goldCost: 300, outputBaseId: 'starforged_signet', outputILvl: 55,
  ...
  },
  {
    ...
    goldCost: 300, outputBaseId: 'starforged_mace', outputILvl: 55,
  ...
  },
  {
    ...
    goldCost: 300, outputBaseId: 'starforged_breastplate', outputILvl: 55,
