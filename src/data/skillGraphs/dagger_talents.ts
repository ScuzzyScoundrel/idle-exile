  ...
  branches: [
    // --- Assassination ---
    {
      ...
      behaviorNodes: {
        ...
        t2b: bh('Honed Instincts', 'After crit: +4% crit mult 2s (stacks 2x). R2: 3s, stacks 3x.',
          { incCritMultiplier: 4 },
        ...
        t4b: bh('Predator\'s Mark', 'In Predator: 20% double strike (60% wpn dmg). R2: 35%.',
          { conditionalMods: [{ condition: 'whileBuffActive', buffId: 'predator', modifier: { incDamage: 12 } }] },
          { 1: { conditionalMods: [{ condition: 'whileBuffActive', buffId: 'predator', modifier: { incDamage: 12 } }] },
            2: { conditionalMods: [{ condition: 'whileBuffActive', buffId: 'predator', modifier: { incDamage: 20 } }] } }),
      },
      t5a: {
      ...
      behaviorNodes: {
        ...
        t4b: bh('Shadow Strikes', 'In Shadow Form: Stab applies Blind (1s). R2: +1 Fortify/hit.',
          ...
          { 1: { conditionalMods: [{ condition: 'whileBuffActive', buffId: 'shadowForm', modifier: { incDamage: 15 } }] },
            2: { conditionalMods: [{ condition: 'whileBuffActive', buffId: 'shadowForm', modifier: { incDamage: 15, incCritChance: 10 } }] } }),
      },
      t5a: {
  ...
  branches: [
    // --- Assassination ---
    {
      ...
      behaviorNodes: {
        ...
        t2b: bh('Precision Cuts', '+2% crit mult per hit for 3s. R2: persists until non-BF cast.',
          { incCritMultiplier: 2 },
          { 1: { incCritMultiplier: 2 }, 2: { incCritMultiplier: 2 } }),
      ...
      behaviorNodes: {
        ...
        t1b: bh('Overload', '+10% crit vs Shocked. R2: +8% crit mult vs Shocked.',
          ...
          { 1: { conditionalMods: [{ condition: 'whileDebuffActive', modifier: { incCritChance: 10 } }] },
            2: { conditionalMods: [{ condition: 'whileDebuffActive', modifier: { incCritChance: 10, incCritMultiplier: 4 } }] } }),
