  ...
  branches: [
      ...
      t2Notable: {
        ...
        modifier: {
          ...
          procs: [{ id: 'bf_cascade_instinct', chance: 0.20, trigger: 'onCastComplete',
            applyBuff: { buffId: 'stormState', effect: { critMultiplierBonus: 40 }, duration: 4 } }],
        },
      },
      t4Notable: {
      ...
      t5a: {
        ...
        modifier: {
          ...
          procs: [{ id: 'bf_flurry_of_steel', chance: 1.0, trigger: 'onCastComplete',
            applyBuff: { effect: { critMultiplierBonus: 15 }, duration: 4 } }],
        },
      },
      t5b: {
        name: 'Cascade Killer',
    ...
    // --- Venomcraft ---
    {
      ...
      t2Notable: {
        ...
        description: 'Per-hit on poisoned: 3% double stacks (+3%/stack, max 18%). 5+ stacks in cast: 40% DoT burst. +10% poison dmg.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
          procs: [
      ...
      t4Notable: {
        ...
        description: '4+ poison stacks applied in one cast: Venom Surge (5s, +1 poison/hit, +25% poison). 15s ICD.',
        nodeType: 'notable', maxRank: 1, procPattern: 'state-shift',
        modifier: {
      ...
      t5a: {
        ...
        description: 'Per hit: +5% dmg per poison stack (cap +50%). BF poison +2s duration.',
        nodeType: 'keystoneChoice', maxRank: 1,
        modifier: {
      ...
      t6Notable: {
        name: 'Plague Cascade',
        description: 'On kill with BF: spread poison = hits in kill cast. 4+ hits: spread all debuffs.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
    ...
    // --- Shadow Dance ---
    {
      ...
      t2Notable: {
        ...
        description: 'After BF cast: Flicker Charge (3s). Dodge w/ charge: -2s BF CD, +1 Fortify (5s, 3% DR). 5s ICD. +5 all resist.',
        nodeType: 'notable', maxRank: 1, procPattern: 'cooldown',
        modifier: {
          abilityEffect: { resistBonus: 5 },
          procs: [
...
export const FROST_FAN_TALENT_TREE = createTalentTree({
  ...
  branches: [
    ...
    // --- Venomcraft ---
    {
      ...
      t2Notable: {
        name: 'Blight Surge',
        description: 'Guaranteed poison (3s). Poison 4+ targets in cast: 30% Blight Pulse (40% DoT to all poisoned). +10% poison dmg.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
          procs: [
      ...
      t4Notable: {
        name: 'Miasma Cascade',
        description: 'Poison +20%. Poison 5+ targets in cast: Miasma (5s, +2 poison/hit, 15% tick spread). 18s ICD.',
        nodeType: 'notable', maxRank: 1, procPattern: 'state-shift',
        modifier: {
      ...
      t5a: {
        name: 'Creeping Frost',
        description: 'Poison +8% per poisoned target (max +40%). Poison duration +30%.',
        nodeType: 'keystoneChoice', maxRank: 1,
        modifier: {
      ...
      t6Notable: {
        ...
        description: 'Kill poisoned (5+ stacks): explode half stacks to AoE range. Inherit duration.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
    ...
    // --- Shadow Dance ---
    {
      ...
      t2Notable: {
        name: 'Hailguard',
        description: 'FF hits: Frost Fortify (1 stack/2 targets, 5s, 3% DR, max 3). Dodge: 30% reset FF CD. +5 cold resist.',
        nodeType: 'notable', maxRank: 1, procPattern: 'cooldown',
        modifier: {
          fortifyOnHit: { stacks: 1, duration: 5, damageReduction: 3 },
          procs: [{ id: 'ff_hailguard', chance: 0.30, trigger: 'onDodge',
  ...
  branches: [
    // --- Assassination ---
    {
      ...
      behaviorNodes: {
        ...
        t3a: bh('Lethal Dose', '5+ poison stacks: crits +20% damage. R2: threshold 3.',
          ...
          { 1: { conditionalMods: [{ condition: 'whileDebuffActive', modifier: { incDamage: 20 } }] },
            2: { conditionalMods: [{ condition: 'whileDebuffActive', modifier: { incDamage: 20 } }] } }),
        t3b: bh('Expiring Venom', 'Poison expiry: 40% remaining DoT as burst. R2: reapply 2 stacks.',
        ...
        t4b: bh('Predator\'s Venom', 'In Serpent Clarity: poison ticks +30%. R2: extends poison +1s.',
    ...
    // --- Venomcraft ---
    {
      ...
      t2Notable: {
        ...
        description: 'DoT snapshot +15%. 5+ stacks: 30%/tick Corroded (4s ICD). +15% poison dur.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
      ...
      t4Notable: {
        name: 'Putrid Bloom',
        description: 'Poison +20%. On DoT expiry: Venom Frenzy (5s, +25% speed, +2 stacks, +20% snap). 15s ICD.',
        nodeType: 'notable', maxRank: 1, procPattern: 'state-shift',
        modifier: {
          debuffInteraction: { debuffEffectBonus: 20 },
      ...
      t5a: {
        name: 'Creeping Rot',
        description: 'No stack cap. +2% per stack beyond 10. +30% dur. Disable stack consumption.',
        nodeType: 'keystoneChoice', maxRank: 1,
        modifier: { debuffInteraction: { debuffEffectBonus: 2, debuffDurationBonus: 30 } },
      },
      t5b: {
        name: 'Virulent Detonation',
        description: '8+ stacks: 25% detonate all for 100% DoT. Post-detonation -30% (3s).',
        nodeType: 'keystoneChoice', maxRank: 1,
        modifier: {
      ...
      t6Notable: {
        ...
        description: '10+ stacks: convert 3 to Blight (150% DoT, 8s ICD). +25% poison while Blighted.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
    ...
    // --- Shadow Dance ---
    {
      ...
      t2Notable: {
        name: 'Coiling Ward',
        description: '10%/tick Fortify (5s, 3% DR). Dodge w/Fortify: -1s VS CD. +5 resist.',
        nodeType: 'notable', maxRank: 1, procPattern: 'cooldown',
        modifier: {
          fortifyOnHit: { stacks: 1, duration: 5, damageReduction: 3 },
          abilityEffect: { resistBonus: 5 },
          procs: [{ id: 'vs_coiling_ward_cd', chance: 1.0, trigger: 'onDodge',
            resetCooldown: 'self' }],
        },
      },
      t4Notable: {
      ...
      behaviorNodes: {
        ...
        t4b: bh('Serpent\'s Shadow', 'Serpent Form: VS DoT ticks Blind (0.5s). R2: DoT +20%.',
          { conditionalMods: [{ condition: 'whileBuffActive', buffId: 'serpentForm', modifier: { } }] },
          { 1: { }, 2: { } }),
      },
      t5a: {
  ...
  branches: [
    // --- Assassination ---
    {
      ...
      behaviorNodes: {
        ...
        t3b: bh('Ghost Predator', 'Kill while consuming charges: regain 1 charge. R2: +15% damage 3s on regain.',
    ...
    // --- Venomcraft ---
    {
      ...
      t2Notable: {
        ...
        description: 'Stealth: 3 poison (ignore resist). 4+ stacks: Cursed (3s) + charge. +15% poison.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
      ...
      t4Notable: {
        ...
        description: 'Stealth at 6+ stacks: Shadow Venom Frenzy (5s, +25% speed, +2 stacks/hit, charge refund). 18s ICD.',
        nodeType: 'notable', maxRank: 1, procPattern: 'state-shift',
        modifier: {
      ...
      t5a: {
        ...
        description: 'Stealth: +15%/stack poison, +50% dur. +1s CD increase.',
        nodeType: 'keystoneChoice', maxRank: 1,
        modifier: { debuffInteraction: { debuffEffectBonus: 15, debuffDurationBonus: 50 } },
      },
      t5b: {
        name: 'Blight Detonation',
        description: 'Consume ALL charges + stacks. 25%/charge of DoT. 3+ charges: Vulnerable+Cursed. +8s CD.',
        nodeType: 'keystoneChoice', maxRank: 1,
        modifier: {
      ...
      t6Notable: {
        name: 'Miasma Shroud',
        description: 'Stealth kill: spread ALL debuffs +50% dur +2 poison. 3+ types: +2 charges + 1s stealth.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
          debuffInteraction: { spreadDebuffOnKill: { debuffIds: ['all'], refreshDuration: 1 } },
    ...
    // --- Shadow Dance ---
    {
      ...
      t2Notable: {
        name: 'Umbral Shield',
        description: 'Cast: 1 Fortify (5s, 3% DR). Dodge in 3s: consume charge → +2 Fortify + 3% heal (6s ICD). +5 resist.',
        nodeType: 'notable', maxRank: 1, procPattern: 'cooldown',
        modifier: {
          fortifyOnHit: { stacks: 1, duration: 5, damageReduction: 3 },
          abilityEffect: { resistBonus: 5 },
      ...
      behaviorNodes: {
        ...
        t3c: bh('Shadow Tempo', 'Dodge: reduce SS CD 0.8s. R2: 1.2s.',
          { cooldownReduction: 8 },
          { 1: { cooldownReduction: 8 }, 2: { cooldownReduction: 12 } }),
        t4b: bh('Spectral Shadow', 'Umbral Form: SS costs no CD. R2: +1 Stealth per SS cast.',
          { conditionalMods: [{ condition: 'whileBuffActive', buffId: 'umbralForm', modifier: { cooldownReduction: 100 } }] },
          { 1: { }, 2: { } }),
      },
      t5a: {
  ...
  branches: [
    // --- Assassination ---
    {
      ...
      t2Notable: {
        ...
        modifier: {
          ...
          procs: [{ id: 'as_marked_for_death', chance: 1.0, trigger: 'onCast',
            applyBuff: { buffId: 'executionMomentum', effect: { critMultiplierBonus: 20 }, duration: 30 } }],
        },
      },
      t4Notable: {
        name: 'Fatal Opening',
      ...
      behaviorNodes: {
        ...
        t3a: bh('Toxic Concentration', '5+ stacks: +20% damage. R2: threshold 3.',
          { conditionalMods: [{ condition: 'whileDebuffActive', modifier: { incDamage: 20 } }] },
          { 1: { }, 2: { } }),
      ...
      t5a: {
        ...
        modifier: {
          procs: [{ id: 'as_inevitable_end', chance: 1.0, trigger: 'onCrit',
            applyBuff: { effect: { critMultiplierBonus: 64 }, duration: 8 } }],
        },
      },
      t5b: {
      ...
      t6Notable: {
        ...
        modifier: {
          ...
          debuffInteraction: { bonusDamageVsDebuffed: { debuffId: 'guillotineMark', incDamage: 400 } },
        },
      },
      t7Keystone: {
        name: 'FINAL JUDGMENT',
    ...
    // --- Venomcraft ---
    {
      ...
      t2Notable: {
        ...
        description: '+30% poison snapshot from weapon%. 5+ stacks: 40% Venom Eruption (80% DoT as instant chaos). +15% poison.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
          debuffInteraction: { debuffDurationBonus: 15 },
          procs: [
      ...
      t4Notable: {
        name: 'Venom Apex',
        description: '8+ stacks: Venom Apex (6s) — next Assassinate +50% weapon% (2.2→3.3), double poison. 16s ICD.',
        nodeType: 'notable', maxRank: 1, procPattern: 'state-shift',
        modifier: {
      ...
      t5a: {
        ...
        description: '+15% per stack (mult). +50% duration. Single poison application per cast.',
        nodeType: 'keystoneChoice', maxRank: 1,
        modifier: { debuffInteraction: { debuffEffectBonus: 15, debuffDurationBonus: 50 } },
      },
      t5b: {
      ...
      t6Notable: {
        ...
        description: 'Kill w/ 5+ stacks: 60% poison as AoE chaos to next enemy, apply half stacks. No ICD.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
          debuffInteraction: { spreadDebuffOnKill: { debuffIds: ['poisoned'], refreshDuration: 1 } },
    ...
    // --- Shadow Dance ---
    {
      ...
      t2Notable: {
        ...
        description: 'Dodge during CD: +1 stack (max 4, +5% DR each). CD expiry: consume for +10% damage/stack (max +40%). +5% evasion.',
        nodeType: 'notable', maxRank: 1, procPattern: 'cooldown',
        modifier: {
          damageFromEvasion: 5,
          procs: [{ id: 'as_coiled_patience', chance: 1.0, trigger: 'onDodge',
  ...
  branches: [
    // --- Assassination ---
    {
      ...
      t2Notable: {
        ...
        modifier: {
          ...
          procs: [{ id: 'll_stormcaller', chance: 0.15, trigger: 'onHit',
            applyBuff: { buffId: 'stormcaller', effect: { critMultiplierBonus: 45 }, duration: 3 } }],
        },
      },
      t4Notable: {
        name: 'Storm Exploit',
      ...
      t5a: {
        ...
        modifier: {
          ...
          procs: [{ id: 'll_conducting_fury', chance: 1.0, trigger: 'onHit',
            applyBuff: { buffId: 'conductingCharge', effect: { critMultiplierBonus: 8 }, duration: 8 } }],
        },
      },
      t5b: {
      ...
      t6Notable: {
        ...
        modifier: {
          ...
          debuffInteraction: { bonusDamageVsDebuffed: { debuffId: 'thunderousMark', incDamage: 80 } },
        },
      },
      t7Keystone: {
    ...
    // --- Venomcraft ---
    {
      ...
      t2Notable: {
        ...
        description: '3+ poisoned in chain: Conductive Burst (40% poison DoT as instant lightning). 10+ total stacks: also Shock (2). +12% poison.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
          debuffInteraction: { debuffDurationBonus: 12 },
          procs: [
      ...
      t4Notable: {
        ...
        description: '15+ total poison across chain: Venom Frenzy (5s) — +25% cast speed, +1 poison/jump, +30% range. 18s ICD.',
        nodeType: 'notable', maxRank: 1, procPattern: 'state-shift',
        modifier: {
      ...
      t5a: {
        ...
        description: 'Chain poison +8% more per target (mult). Jump to poisoned: extend +1s. Duration +20%.',
        nodeType: 'keystoneChoice', maxRank: 1,
        modifier: { debuffInteraction: { debuffEffectBonus: 8, debuffDurationBonus: 20 } },
      },
      t5b: {
        name: 'Volatile Chain',
        description: '4+ poisoned in chain: 25% detonate ALL (120% DoT as instant lightning AoE). Deaths spread 3 stacks. -15% poison dur.',
        nodeType: 'keystoneChoice', maxRank: 1,
        modifier: {
          debuffInteraction: { debuffDurationBonus: -15 },
      ...
      t6Notable: {
        name: 'Plague Arc',
        description: 'Chain jumps propagate ALL debuffs (retain stacks+dur). +20% remaining as bonus lightning. 3+ types: +30% taken 3s.',
        nodeType: 'notable', maxRank: 1, procPattern: 'gated',
        modifier: {
    ...
    // --- Shadow Dance ---
    {
      ...
      t2Notable: {
        ...
        description: 'Dodge: 30% Flickering (3s) — next LL +2 chains, free cast. Full chain: heal 4%/target. +8% evasion.',
        nodeType: 'notable', maxRank: 1, procPattern: 'cooldown',
        modifier: {
          damageFromEvasion: 8,
          procs: [{ id: 'll_flickering_chains', chance: 0.30, trigger: 'onDodge',
