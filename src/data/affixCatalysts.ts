...
export const AFFIX_CATALYST_DEFS: AffixCatalystDef[] = [
  { id: 'whetstone',         name: 'Whetstone',         icon: '\u{1F5E1}\uFE0F', guaranteedAffix: 'flat_phys_damage',  affixSlot: 'prefix' },
  { id: 'destruction_lens',  name: 'Destruction Lens',  icon: '\uD83D\uDCA5', guaranteedAffix: 'inc_phys_damage',   affixSlot: 'prefix' },
  ...
  { id: 'brutality_shard',   name: 'Brutality Shard',   icon: '\uD83D\uDCA2', guaranteedAffix: 'crit_multiplier',   affixSlot: 'suffix' },
  { id: 'vitality_essence',  name: 'Vitality Essence',  icon: '\u2764\uFE0F', guaranteedAffix: 'flat_max_life',     affixSlot: 'prefix' },
  { id: 'fortification_kit', name: 'Fortification Kit', icon: '\uD83D\uDEE1\uFE0F', guaranteedAffix: 'flat_armor',        affixSlot: 'prefix' },
  { id: 'evasion_charm',     name: 'Evasion Charm',     icon: '\uD83D\uDCA8', guaranteedAffix: 'flat_evasion',      affixSlot: 'prefix' },
  { id: 'haste_crystal',     name: 'Haste Crystal',     icon: '\u23F0',       guaranteedAffix: 'ability_haste',     affixSlot: 'suffix' },
];
